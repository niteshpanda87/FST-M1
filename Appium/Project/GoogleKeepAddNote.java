...
public class GoogleKeepAddNote {
  ...
  public void createNewNote() {
	  ...
	  // Enter the title
	  driver.findElement(AppiumBy.id("com.google.android.keep:id/editable_title")).sendKeys("FST Note");
	  
	  // Enter the description
	  driver.findElement(AppiumBy.id("com.google.android.keep:id/edit_note_text")).sendKeys("This is a FST Test notes");
	  ...
	  String note = driver.findElement(AppiumBy.xpath("//android.widget.TextView[@resource-id=\"com.google.android.keep:id/index_note_title\" and @text=\"FST Note\"]\n"
	  		+ "")).getText();
	  Assert.assertEquals(note, "FST Note");
  }
